...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UIBarButtonItem.appearance().tintColor = UIColor(red: 235.0/255, green: 73.0/255.0, blue: 27.0/255, alpha: 1.0)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "KenTaps.CoreData" in the application's documents Application Support directory.
